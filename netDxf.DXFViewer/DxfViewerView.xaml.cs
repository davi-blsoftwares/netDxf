using netDxf.ConversionToShape;
using System;
...
namespace netDxf.DXFViewer
{
    /// <summary>
    /// Interação lógica para DxfViewerView.xam
    /// </summary>
    public partial class DxfViewerView : UserControl, INotifyPropertyChanged
    {
        #region Fields

        public static readonly DependencyProperty FileNameProperty = DependencyProperty.Register(nameof(FileName), typeof(string), typeof(DxfViewerView), new PropertyMetadata(null, new PropertyChangedCallback(OnFilenameChanged)));

        public static readonly DependencyProperty PanEnabledProperty = DependencyProperty.Register(nameof(PanEnabled), typeof(bool), typeof(DxfViewerView), new PropertyMetadata(false, new PropertyChangedCallback(OnPanEnabledChanged)));

        public static readonly DependencyProperty ScaleXProperty = DependencyProperty.Register(nameof(ScaleX), typeof(double), typeof(DxfViewerView), new PropertyMetadata(1.0));

        public static readonly DependencyProperty ScaleYProperty = DependencyProperty.Register(nameof(ScaleY), typeof(double), typeof(DxfViewerView), new PropertyMetadata(1.0));
        ...
        // Bounding box
        private Vector3 drawingExtendsUpperRight;

        private Vector3 drawingExtendsLowerRight;
        ...
        {
            var instance = (d as DxfViewerView);
        ...
        private void LoadBackground()
        {
            ...
            {
                drawingExtendsUpperRight = dxf.Document.DrawingVariables.ExtMax;
                drawingExtendsLowerRight = dxf.Document.DrawingVariables.ExtMin;
        ...
        public void ZoomExtents()
        {
            ...
            double xMin = Math.Min(drawingExtendsLowerRight.X * ScaleX, drawingExtendsUpperRight.X * ScaleX);
            double xMax = Math.Max(drawingExtendsLowerRight.X * ScaleX, drawingExtendsUpperRight.X * ScaleX);
            double yMin = Math.Min(drawingExtendsUpperRight.Y * -ScaleY, drawingExtendsLowerRight.Y * -ScaleY);
            double yMax = Math.Max(drawingExtendsUpperRight.Y * -ScaleY, drawingExtendsLowerRight.Y * -ScaleY);
